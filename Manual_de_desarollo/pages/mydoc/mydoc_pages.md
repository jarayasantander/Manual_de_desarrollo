...
Extract bike es una página open source y colaborativa de [Wolfram Schneider](https://wolfram.schneider.org) que se basa en el formato Open Street Map. Esta página sirve como fuente de información para poder  levantar mapas y componentes. 

La página permite elegir cierto región y se ofrece muchas variables de información entre las cuales se destacan:
...
La variable geometry es la principal, dado que da que se está mostrando. puede ser tanto un punto ‘point’ , una línea “linestring’ /’ polyline’ o un ‘multypoligon’ que sirve para describir cuadras. 


Posteriormente viene la  la variable highway, que puede indicar tanto un ‘point’ como un ‘polyline’ como.
...
Disponible en [Extract Bike](https://extract.bbbike.org/)
