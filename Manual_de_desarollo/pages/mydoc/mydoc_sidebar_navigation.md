...
El proyecto se está armando en Node.js Las apis de google están integradas en node además de ser una plataforma diseñada para utilizar requests. 


La conexión del sistema completo es el siguiente:

<!-- foto -->

{% include image.html file="Conexión.png"  alt="Jekyll" caption="Esquema de Conexión" %}

El ambiente se en una primera instancia en heroku que permite un  amigable entorno de ambiente para páginas sencillas. 
